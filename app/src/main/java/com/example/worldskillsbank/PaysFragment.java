 ...
 * Use the {@link PaysFragment#newInstance} factory method to
...
public class PaysFragment extends Fragment {
    ...
    public static PaysFragment newInstance(String param1, String param2) {
        PaysFragment fragment = new PaysFragment();
